...
$('#btnSubmit').click(function () {
    ...
    console.log("[DEBUG] projData being sent:", JSON.stringify(projData));
    $.post("StartEnvironmentSetupProcess", projData, function (data) {
        console.log("[DEBUG] StartEnvironmentSetupProcess response:", data, "type:", typeof data);
        if (data !== true && data !== "True") {
            //var queryTemplate = '@Request.QueryString["queryTemplate"]';
            //window.location.href = "~/Account/Verify?template=" + queryTemplate;
            //return;
            console.log("[DEBUG] Session expired check FAILED. data value:", JSON.stringify(data));
            if (confirm("Session expired! click OK to reload")) {
                window.location.href = "../account/index";
            }
            else {
