...
namespace VstsDemoBuilder.Services
{
    public class ProjectService : IProjectService
    {
        ...
        {
            string defaultHost = VstsDemoBuilder.Infrastructure.AppSettings.Get("DefaultHost");
            string ProjectCreationVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("ProjectCreationVersion");
        ...
        public string[] CreateProjectEnvironment(Project model)
        {
            ...
            string projectCreationVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("ProjectCreationVersion");
            string repoVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("RepoVersion");
            string buildVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("BuildVersion");
            string releaseVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("ReleaseVersion");
            string wikiVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("WikiVersion");
            string boardVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("BoardVersion");
            string workItemsVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("WorkItemsVersion");
            string queriesVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("QueriesVersion");
            string endPointVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("EndPointVersion");
            string extensionVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("ExtensionVersion");
            string dashboardVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("DashboardVersion");
            string agentQueueVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("AgentQueueVersion");
            string getSourceCodeVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("GetSourceCodeVersion");
            string testPlanVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("TestPlanVersion");
            string releaseHost = VstsDemoBuilder.Infrastructure.AppSettings.Get("ReleaseHost");
            string defaultHost = VstsDemoBuilder.Infrastructure.AppSettings.Get("DefaultHost");
            string deploymentGroup = VstsDemoBuilder.Infrastructure.AppSettings.Get("DeloymentGroup");
            string graphApiVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("GraphApiVersion");
            string graphAPIHost = VstsDemoBuilder.Infrastructure.AppSettings.Get("GraphAPIHost");
            string gitHubBaseAddress = VstsDemoBuilder.Infrastructure.AppSettings.Get("GitHubBaseAddress");
            string variableGroupsApiVersion = VstsDemoBuilder.Infrastructure.AppSettings.Get("VariableGroupsApiVersion");
            ...
            string logWIT = VstsDemoBuilder.Infrastructure.AppSettings.Get("LogWIT");
            if (logWIT == "true")
            {
                string patBase64 = VstsDemoBuilder.Infrastructure.AppSettings.Get("PATBase64");
                string url = VstsDemoBuilder.Infrastructure.AppSettings.Get("URL");
                string projectId = VstsDemoBuilder.Infrastructure.AppSettings.Get("PROJECTID");
        ...
        private void CreateServiceEndPoint(Project model, List<string> jsonPaths, Configuration _endpointConfig)
        {
            try
            {
                ...
                foreach (string jsonPath in jsonPaths)
                {
                    ...
                    {
                        string username = VstsDemoBuilder.Infrastructure.AppSettings.Get("UserID");
                        string password = VstsDemoBuilder.Infrastructure.AppSettings.Get("Password");
                        ...
                        string gitUserName = VstsDemoBuilder.Infrastructure.AppSettings.Get("GitUserName");
                        string gitUserPassword = VstsDemoBuilder.Infrastructure.AppSettings.Get("GitUserPassword");
                        ...
                        {
                            string bikeSharing360username = VstsDemoBuilder.Infrastructure.AppSettings.Get("UserID");
                            string bikeSharing360password = VstsDemoBuilder.Infrastructure.AppSettings.Get("BikeSharing360Password");
                        ...
                        {
                            string contosousername = VstsDemoBuilder.Infrastructure.AppSettings.Get("ContosoUserID");
                            string contosopassword = VstsDemoBuilder.Infrastructure.AppSettings.Get("ContosoPassword");
