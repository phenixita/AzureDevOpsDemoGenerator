                ...
                $.get(url2, function (response) {
                    ...
                    if (response === "100" || response === "") {
                        ...
                        if (ErrorData !== '') {
                            ...
                            $("#projCreateMsg").hide();
                            $('<b style="display: block;">We ran into some issues and we are sorry about that!</b><p> The log below will provide you insights into why the provisioning failed. You can raise an issue with the error logs <a id="EmailPopup" href="https://github.com/phenixita/AzureDevOpsDemoGenerator/issues/new" target="_blank">here</a> and we will try to help you.</p><p>Click on View Diagnostics button to share logs with us.</p>').appendTo("#errorDescription");
                            $('#GenerateArtifacts').removeClass('lodergif');
                            //$('#ExdvProgress').removeClass("d-block").addClass("d-none");
